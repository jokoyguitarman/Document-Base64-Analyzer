...
class BatchProcessingMonitor:
                ...
                for worker, tasks in active_tasks.items():
                    if tasks:
                        ...
                        for task in tasks:
                            ...
                            elif 'process_document_batch' in task_name:
                                batch_stats['tasks']['batch_processing'] += 1
                            elif 'process_document_job' in task_name:
                                batch_stats['tasks']['document_orchestration'] += 1
    ...
    def estimate_completion_time(self, job_id, pages_remaining):
        """Estimate completion time for a batch processing job"""
        try:
            ...
            # Factor in parallel processing (25 pages per batch, multiple workers)
            parallel_factor = 6  # Assuming 6 concurrent page workers
            
            estimated_seconds = (pages_remaining * avg_time_per_page) / parallel_factor
